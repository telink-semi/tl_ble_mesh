...
#define proxy_cfg_list_init_upon_connection(conn_handle)    proxy_filter_list_init(conn_handle)
...
u8 proxy_filter_change_by_mesh_net(u16 unicast_adr);
...
#endif
u8 mesh_get_proxy_privacy_para(void);
