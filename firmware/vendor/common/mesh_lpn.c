...
void suspend_enter(u32 sleep_ms, int deep_retention_flag)
{
    ...
    #if(__TL_LIB_8258__ || (MCU_CORE_TYPE == MCU_CORE_8258) || (MCU_CORE_TYPE == MCU_CORE_8278)||(MCU_CORE_TYPE == MCU_CORE_B91))
    sleep_mode = deep_retention_flag ? ((MCU_CORE_TYPE == MCU_CORE_B91) ? DEEPSLEEP_MODE_RET_SRAM_LOW64K : DEEPSLEEP_MODE_RET_SRAM_LOW32K) : SUSPEND_MODE;
    #endif
