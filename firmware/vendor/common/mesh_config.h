...
#endif
#ifndef ATT_REPLACE_PROXY_SERVICE_EN
#define ATT_REPLACE_PROXY_SERVICE_EN		0
#endif
...
#define FEATURE_FRIEND_EN		0
	#else
#define FEATURE_FRIEND_EN 		0   // WIN 32 should be suport disable: model_sig_cfg_s.frid
	#endif
#define FEATURE_LOWPOWER_EN		0
#define FEATURE_PROV_EN 		1
