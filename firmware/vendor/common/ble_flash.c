...
_attribute_data_retention_	u32 flash_sector_mac_address = CFG_SECTOR_ADR_MAC_CODE;
_attribute_data_retention_	u32 flash_sector_calibration = CFG_SECTOR_ADR_CALIBRATION_CODE;
