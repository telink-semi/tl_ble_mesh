...
#define ACL_PERIPHR_SMP_ENABLE						(0 || MESH_CDTP_ENABLE)   //1 for smp,  0 no security
...
#define TLKAPI_DEBUG_CHANNEL         		 		TLKAPI_DEBUG_CHANNEL_UART	// USB is occupied by gateway TX/RX.
#else
