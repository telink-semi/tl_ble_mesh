...
//	audio_data_fifo1_path_sel(FIFO1, SAR_ADC_IN_FIFO);//connect DMA and ADC by audio input fifo1.
}
/**
...
{
	dma_set_address(adc_dma_chn,REG_AUDIO_FIFO_ADDR(1),(unsigned int)adc_data_buf);
