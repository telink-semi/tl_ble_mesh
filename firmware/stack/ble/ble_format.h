...
#if 1 // BLE_SRC_TELINK_MESH_EN, move from adv_stack.h
...
typedef struct __attribute__((packed)) { // BLE_SRC_TELINK_MESH_EN, move from ble_stack.h
    u8  type;
    u8  rf_len;
    u16 l2capLen;
    u16 chanId;
