...
#define CHARACTERISTIC_UUID_ENHANCED_INTERIM_CUFF_PRESSURE		0x2B35 //Enhanced Intermediate Cuff Pressure
...
extern const unsigned char characteristicEnhancedInterimCuffPressureUuid[ATT_16_UUID_LEN];
