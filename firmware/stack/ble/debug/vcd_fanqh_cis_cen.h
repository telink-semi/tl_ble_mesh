...
#if (VCD_DEFINE_SELECT == VCD_FANQH_DEFINE_CIS_CEN)
...
#define			SLEV_cis_rx_nex_buff		22
...
#define			SL16_cis0_txSetPDUNum		17
#define			SL16_cis1_txSetPDUNum		18
