 ...
 */
	...
	#define	SDK_VERSION1(sdk_version_num)	"$$$B930_ble_multiple_connection_sdk_V"#sdk_version_num"$$$"
#elif (MCU_CORE_TYPE == MCU_CORE_B95)
	#define B92_SDK_VERSION_NUM				CERTIFICATION_MARK.SOFT_STRUCTURE.MAJOR_VERSION.MINOR_VERSION
	#define SDK_VERSION_NUM					B92_SDK_VERSION_NUM

	#define	SDK_VERSION1(sdk_version_num)	"$$$B95_ble_multiple_connection_sdk_V"#sdk_version_num"$$$"
#endif
