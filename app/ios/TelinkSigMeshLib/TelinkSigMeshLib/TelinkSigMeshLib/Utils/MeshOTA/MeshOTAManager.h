...
typedef enum : UInt8 {
    ...
    SigFirmwareUpdateProgressFirmwareUpdateFirmwareMetadataCheck          = 3,
    SigFirmwareUpdateProgressSubscriptionAdd                              = 4,
    SigFirmwareUpdateProgressFirmwareUpdateInformationGet                 = 5,
